...
export default {
  ...
  data() {
    ...
    return {
      ...
      colKey: {
        ...
        // theoryEquivalentUtilizationHours: '理论等效利用小时(h)'
        // onGridEnergy: {
        //   label: '上网电量(万kWh)',
        //   sortable: true
        // },
  ...
  methods: {
      ...
      this.$axios.get(Api.group.getElectricityConsumption, data, (res) => {
        ...
        if (res.isSuccess) {
          ...
          this.tableData.forEach(item => {
            ...
            this.seriesData1.push(item.equivalentUtilizationHours);
            this.seriesData2.push(item.theoryEquivalentUtilizationHours);
          });
          this.loadChart();
        }
      });
    ...
    handleDownload() {
      const url = `${this.baseUrl}powerGeneration/v1/exportData?exportModel=electricityConsumption&queryType=${this.queryType}&chooseDate=${this.chooseDate}&start=1&size=10000`;
